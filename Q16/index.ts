let inviteee: string[] = ["Qadir", "Ahmad", "Ali", "Khan"];
for (let i=0; i<=3; i++)
{
    console.log("I would like to invite Mr",inviteee[i],"For dinner");
}

let can_guest: string = inviteee[0];
let rep_guest: string ="Kamran";
...
let index_to_add_at: number = 0;
let add_name: string = "Touseef";
...
let index_to_add_at_middle: number = 3;
let add_name_at_middle: string = "Laiba";
...
let index_to_add_at_End: number = 6;
let add_name_at_End: string = "uzair";
